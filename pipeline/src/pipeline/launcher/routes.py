...
ROUTES: tuple[Route, ...] = (
    ...
    Route("pr-review", "cli", "pipeline.launcher.cli.pr_review",
          rules=("level-known", "review-efforts-known", "verbose-xor-quiet",
                 "heartbeat-positive")),
    Route("refinement", "cli", "pipeline.launcher.cli.refinement",
          rules=("refinement-efforts-known", "verbose-xor-quiet",
                 "heartbeat-positive")),
    ...
    Route("refinement-trigger", "hook",
          "pipeline.launcher.hooks.refinement_trigger"),
